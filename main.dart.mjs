...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1274: x0 => x0.pause(),
      _1297: x0 => x0.load(),
      _1318: () => new webkitSpeechRecognition(),
      ...
      _1338: () => new AudioContext(),
      _1339: (x0,x1) => x0.createMediaElementSource(x1),
      _1340: x0 => x0.createStereoPanner(),
      _1341: (x0,x1) => x0.connect(x1),
      _1342: x0 => x0.remove(),
      _1346: x0 => ({frequency: x0}),
      _1347: x0 => new Accelerometer(x0),
      _1348: x0 => x0.start(),
      ...
      _1366: () => new SpeechSynthesisUtterance(),
      _1367: x0 => x0.pause(),
      _1368: x0 => x0.resume(),
      ...
      _1375: (x0,x1) => x0.speak(x1),
      _1376: x0 => x0.cancel(),
      _1377: x0 => x0.getVoices(),
      _1387: Date.now,
      ...
      _1425: Object.is,
      _1426: o => o instanceof Array,
      _1430: (a, l) => a.length = l,
      _1431: a => a.pop(),
      _1432: (a, i) => a.splice(i, 1),
      _1433: (a, s) => a.join(s),
      _1434: (a, s, e) => a.slice(s, e),
      _1436: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1437: a => a.length,
      ...
      _1443: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1445: o => o instanceof Uint8Array,
      _1446: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1447: o => o instanceof Int8Array,
      _1448: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1449: o => o instanceof Uint8ClampedArray,
      _1450: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1451: o => o instanceof Uint16Array,
      _1452: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1453: o => o instanceof Int16Array,
      _1454: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1455: o => o instanceof Uint32Array,
      _1456: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1457: o => o instanceof Int32Array,
      _1458: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1460: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1461: o => o instanceof Float32Array,
      _1462: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1463: o => o instanceof Float64Array,
      _1464: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1465: (t, s) => t.set(s),
      _1466: l => new DataView(new ArrayBuffer(l)),
      _1467: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1469: o => o.buffer,
      _1470: o => o.byteOffset,
      _1471: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1472: (b, o) => new DataView(b, o),
      _1473: (b, o, l) => new DataView(b, o, l),
      _1474: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1475: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1476: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1477: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1478: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1479: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1480: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1481: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1482: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1483: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1484: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1485: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1488: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1489: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1490: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1491: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1492: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1493: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1506: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1507: (handle) => clearTimeout(handle),
      _1508: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1509: (handle) => clearInterval(handle),
      _1510: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1511: () => Date.now(),
      _1516: o => Object.keys(o),
      _1517: () => new XMLHttpRequest(),
      _1518: (x0,x1,x2) => x0.open(x1,x2),
      _1519: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1520: x0 => x0.abort(),
      _1521: (x0,x1) => x0.send(x1),
      _1522: x0 => x0.send(),
      _1523: x0 => x0.getAllResponseHeaders(),
      ...
      _1546: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1547: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1577: (s, m) => {
        try {
      ...
      _1578: (x0,x1) => x0.exec(x1),
      _1579: (x0,x1) => x0.test(x1),
      _1580: x0 => x0.pop(),
      _1582: o => o === undefined,
      _1584: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1586: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1587: o => o instanceof RegExp,
      _1588: (l, r) => l === r,
      _1589: o => o,
      _1590: o => o,
      _1591: o => o,
      ...
      _1730: x0 => x0.readyState,
      _1732: (x0,x1) => { x0.timeout = x1 },
      _1734: (x0,x1) => { x0.withCredentials = x1 },
      _1735: x0 => x0.upload,
      _1736: x0 => x0.responseURL,
      _1737: x0 => x0.status,
      _1738: x0 => x0.statusText,
      _1740: (x0,x1) => { x0.responseType = x1 },
      _1741: x0 => x0.response,
      _1753: x0 => x0.loaded,
      _1754: x0 => x0.total,
      _2032: (x0,x1) => { x0.href = x1 },
      _2420: x0 => x0.error,
      _2422: (x0,x1) => { x0.src = x1 },
      _2427: (x0,x1) => { x0.crossOrigin = x1 },
      _2430: (x0,x1) => { x0.preload = x1 },
      _2434: x0 => x0.currentTime,
      _2435: (x0,x1) => { x0.currentTime = x1 },
      _2436: x0 => x0.duration,
      _2441: (x0,x1) => { x0.playbackRate = x1 },
      _2450: (x0,x1) => { x0.loop = x1 },
      _2454: (x0,x1) => { x0.volume = x1 },
      _2471: x0 => x0.code,
      _2472: x0 => x0.message,
      _3051: (x0,x1) => { x0.src = x1 },
      _3057: (x0,x1) => { x0.async = x1 },
      _3518: () => globalThis.window,
      _3581: x0 => x0.navigator,
      _5566: x0 => x0.destination,
      _5663: (x0,x1) => { x0.value = x1 },
      _5921: x0 => x0.pan,
      _6121: x0 => x0.signal,
      _6193: () => globalThis.document,
      _6275: x0 => x0.body,
      _6609: (x0,x1) => { x0.id = x1 },
      _6632: x0 => x0.innerHTML,
      _6633: (x0,x1) => { x0.innerHTML = x1 },
      _7955: x0 => x0.value,
      _7957: x0 => x0.done,
      _8650: x0 => x0.url,
      _8652: x0 => x0.status,
      _8654: x0 => x0.statusText,
      _8655: x0 => x0.headers,
      _8656: x0 => x0.body,
      _8797: (x0,x1) => { x0.onspeechstart = x1 },
      _8807: (x0,x1) => { x0.onnomatch = x1 },
      _8809: (x0,x1) => { x0.onerror = x1 },
      _8811: (x0,x1) => { x0.onstart = x1 },
      _8813: (x0,x1) => { x0.onend = x1 },
      _8814: x0 => x0.error,
      _12269: x0 => x0.name,
      _13009: x0 => x0.x,
      _13010: x0 => x0.y,
      _13011: x0 => x0.z,
      _13012: (x0,x1) => { x0.onreading = x1 },
      _13013: (x0,x1) => { x0.onerror = x1 },
      _13014: x0 => x0.x,
      _13015: x0 => x0.y,
      _13016: x0 => x0.z,
      _13017: (x0,x1) => { x0.onreading = x1 },
      _13018: (x0,x1) => { x0.onerror = x1 },
      _13029: x0 => x0.error,
      _13030: x0 => x0.name,
      _13031: x0 => x0.message,
      _13032: () => globalThis.speechSynthesis,
      _13033: (x0,x1) => { x0.lang = x1 },
      _13035: (x0,x1) => { x0.pitch = x1 },
      _13038: (x0,x1) => { x0.rate = x1 },
      _13040: (x0,x1) => { x0.text = x1 },
      _13041: (x0,x1) => { x0.voice = x1 },
      _13042: x0 => x0.voice,
      _13044: (x0,x1) => { x0.volume = x1 },
      _13045: (x0,x1) => { x0.onstart = x1 },
      _13046: (x0,x1) => { x0.onend = x1 },
      _13047: (x0,x1) => { x0.onpause = x1 },
      _13048: (x0,x1) => { x0.onresume = x1 },
      _13049: (x0,x1) => { x0.onerror = x1 },
      _13050: (x0,x1) => { x0.onboundary = x1 },
      _13052: x0 => x0.lang,
      _13053: x0 => x0.localService,
      _13054: x0 => x0.name,
